    ...
    <div className="bg-[#f9f9f9] text-black grid-paper selection:bg-yellow-200 selection:text-black min-h-screen relative font-sans">
      ...
      <nav className="hidden md:flex h-full w-64 fixed left-0 bg-[#eeeeee]/90 backdrop-blur-md border-r-4 border-black flex-col gap-2 p-6 z-40">
        <div className="mb-10 p-2 border-b-2 border-dashed border-black">
          ...
          <p className="font-label-code text-neutral-500 italic">Full-Stack Scribbles</p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            <span className="material-symbols-outlined">edit_square</span> Projects
          </button>
      ...
      <main className="md:ml-64 p-6 md:p-16 max-w-7xl mx-auto relative z-10 min-h-screen flex flex-col justify-between">
        ...
        <footer className="mt-20 pb-12 text-center relative border-t-4 border-dotted border-black pt-12">
          ...
          <div className="inline-block relative p-8 max-w-xl mx-auto mb-10">
            ...
            <div className="washi-tape-blue" style={{ top: '-10px', right: '20px' }}></div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-black mt-4">
            ...
            <div className="flex gap-6 font-headline-sm text-lg">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:highlighter-yellow px-1.5 transition-all">Twitter</a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:highlighter-cyan px-1.5 transition-all">GitHub</a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:highlighter-yellow px-1.5 transition-all">LinkedIn</a>
            </div>
          </div>

          {/* Decorative Star Doodles */}
          <div className="absolute -bottom-2 left-1/4 text-3xl animate-pulse select-none">⭐</div>
          <div className="absolute bottom-6 right-1/4 text-3xl animate-bounce select-none">✨</div>
        </footer>
      </main>
