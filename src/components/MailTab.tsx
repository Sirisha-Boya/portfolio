...
export default function MailTab() {
  ...
  const [noteColor, setNoteColor] = useState<"yellow" | "cyan" | "pink">(
    "yellow",
  );
  ...
  return (
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div
          id="contact-section"
          className="bg-white p-8 md:p-10 sketchy-border rotate-[-1deg] paper-texture relative"
        >
          <div className="absolute top-2 right-4 text-xs font-mono text-gray-400 select-none">
            STAMP HERE
          </div>
          ...
          <p className="font-body-md text-lg text-gray-600 mb-6 leading-tight">
            Need high-quality web integrations, REST APIs, or cloud solutions?
            Write me a sweet handwritten-style note!
          </p>
          ...
          <AnimatePresence mode="wait">
            {!contactSent ? (
              ...
              >
                <div>
                  <label className="block font-label-code text-base text-gray-700 mb-1">
                    Your Name
                  </label>
                  <input
                    type="text"
              ...
              >
                ...
                <h3 className="font-headline-sm text-2xl text-black mb-2">
                  Letter Sealed & Sent!
                </h3>
                <p className="font-body-md text-xl text-gray-700">
                  Thank you, <strong>{contactName}</strong>! Your email has been
                  delivered to <strong>sirishab9196@gmail.com</strong>. Sirisha
        ...
        <div className="bg-white p-8 md:p-10 sketchy-border rotate-[0.5deg] paper-texture relative">
          ...
          <p className="font-body-md text-lg text-gray-600 mb-6">
            Write on the virtual Guestbook wall! Type your greeting, choose a
            sticky background color, and hit Pin.
          </p>
          ...
          <form onSubmit={handleAddSticky} className="space-y-4">
            ...
            {/* Note Color Selector */}
            <div>
              <label className="block font-label-code text-base text-gray-700 mb-2">
                Paper Color
              </label>
              <div className="flex gap-4">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setNoteColor(item.id as "yellow" | "cyan" | "pink")
                    }
                  ...
                  >
                    <span
                      className={`w-3.5 h-3.5 rounded-full border border-black/10 ${item.color}`}
                    />
                    {item.label}
                  </button>
                ))}
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b-2 border-dashed border-amber-900/35 pb-4 mb-8">
          <div>
            <h2 className="font-headline-md text-2xl text-amber-950 flex items-center gap-2">
              <span className="material-symbols-outlined text-amber-950 font-bold">
                dashboard
              </span>
              Interactive Guestbook Wall
            </h2>
            <p className="font-body-md text-lg text-amber-900">
              Hover, admire, or drag-inspired notes pinned by visitors. Let's
              grow Sirisha's community board!
            </p>
          </div>
